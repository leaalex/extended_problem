...
<!--                                            </div>-->
                                ...
                                <div>
                                    <p>Далее идут таблицы с графиками, в которых рассматривается <strong>отдельно каждая пара смежных операций</strong>. Таблицу ниже нужно заполнить в следующем порядке:</p>
                                    <ol>
