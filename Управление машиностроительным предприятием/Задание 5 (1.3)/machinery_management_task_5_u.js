            ...
            new Vue({
                ...
                <div id="machinery_management_task_5_block">
                    ...
                    <div>
                        ...
                        <table class="source-table" id="source_table_5">
                        <caption>Таблица 5. Изделие – операция – шифр оборудования – профессия – разряд – штучно-калькуляционное время</caption>
                            <tr>
                                <th>Изделие</th>
                    ...
                    <p>Для определения перечня используемого оборудования достаточно обратиться к <a href="#source_table_5">таблице 5</a>, взять столбец «шифр оборудования» и удалить из него все повторяющиеся значения.</p>
                    ...
                    <div>
                        ...
                        <p>Для определения перечня требуемых профессий с разрядами необходимо также обратиться к <a href="#source_table_5">таблице 5</a>, построчно объединить значения из её столбцов <strong>«Профессия»</strong> и <strong>«Разряд»</strong> и затем удалить из полученного результата все повторяющиеся значения.</p>
                    ...
                    <div>
                        ...
                        <div class="problem-hint-block">
                            ...
                            <p>Рассмотрим порядок заполнения данной таблицы на примере оборудования <strong>шифр 3 модель 165</strong>.</p>
                             ...
                             <p>По данным <a href="#source_table_5">таблицы 5</a>, это оборудование используется в производстве <strong>изделия «30»</strong> на <strong>операциях 1 и 3</strong> – соответственно, <strong>6 минут</strong> и <strong>37 минут</strong>. В таблицу эти цифры войдут в виде суммы <strong>(6 + 37 = 43)</strong> по строке «<strong>шифр 1 модель 165</strong>» и столбцу «<strong>30</strong>». В производстве других изделий данное оборудование не участвует. Поэтому в других столбцах по этому оборудованию должны остаться нули.</p>
    
                            <p>Рассмотрим более сложный пример – оборудование <strong>шифр 6 модель 3А161</strong>. По данным <a href="#source_table_5">таблицы 5</a>, это оборудование используется в производстве всех трёх изделий:</p>
                            <ul>
...
<!--                                        </template>-->
                    ...
                    <div>
                        ...
                        <div class="problem-hint-block">
                            <p>Рассмотрим порядок его выполнения на примере <strong>токарей 3 и 4 разрядов.</strong> Первая позиция (<strong>токарь 3 разряда</strong>) используется в процессе изготовления двух изделий:</p>
                            <ul>
...
<!--                                        </template>-->
                    ...
                    <div>
                        ...
                        <div class="problem-hint-block">
                            <p>Для его выполнения следует произвести <strong>аналогичные действия</strong>, что и при выполнении <strong>этапа 2</strong> в процессе расчёта потребного количества <strong>оборудования</strong>.</p>
...
<!--                                        </template>-->
                    ...
                    <div>
                        ...
                        <div class="problem-hint-block">
                            ...
                            <p>В отличие от аналогичного расчёта по оборудованию, <strong>в этом случае нет коэффициента загрузки</strong> и применяется <strong>другое значение часов работы в год</strong> для единицы ресурса (<a href="#source_table_3">таблица 3</a>). В остальном всё то же самое.</p>
                            ...
                            <p><strong>Полученный результат следует округлить в большую сторону до ближайшего целого</strong>. В данном случае получится <strong>13 единиц</strong>.</p>
                            <p>По образу и подобию представленного примера необходимо вписать в таблицу ниже все недостающие значения.</p>
                        </div>
