...
function MatchingTableObjects(element, data) {
  ...
  console.log(this.element.querySelector('.conf-all-answers'))
  ...
  console.log(this.element.querySelectorAll('.conf-table .conf-inputable'))
  ...
  if (answer.get()) {
    ...
    for (key in student_answer) {
      for (l in student_answer[key]) {
        ...
        $('#' + student_answer[key][l]).addClass('not-use')
