...
const presintationSellectorClass = "presentation-block";
...
script.onload = function(){
    ...
    if (typeof pdfjsLib !== 'undefined'){
        PresentationActivation("." + presintationSellectorClass);
    }
    else{
        ...
        PresentationDefaulfViewerActivation("." + presintationSellectorClass);
        // });
    }
...
function PresentationObjects(element){
    ...
    download_block.innerHTML = labels.download_as_label;
