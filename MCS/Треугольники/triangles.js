            ...
            new Vue({
                ...
                <div>
                    ...
                    <div>
                        ...
                        <p><i>Числовые значения основания и высоты должны быть в <strong>сантиметрах</strong> с точностью до <strong>первого</strong> десятичного знака. Вычисленное числовое значение площади должно быть с точность до <strong>второго</strong> десятичного знака.</i></p>
                        <p></p>
                        <table>
                        <tr>
                    ...
                    <div>
                      ...
                      \\[  S_{ср} = \\frac{S_1 + S_2 + S_3}{3} = ? \\] 
                        ...
                        <p><i>Числовые значения должны быть в <strong>см.</strong> с точностью до <strong>второго</strong> десятичного знака.</p>
                        <table>
                        <tr>
                        <tr>
                    ...
                    <div>
                        ...
                        <p><i>Числовые значения площади должны быть в <strong>квадратных сантиметрах</strong> с точностью до <strong>второго</strong> десятичного знака.</i></p>
                    ...
                    <div>
                        ...
                        <p>Сделайте это и значение занесите в соответствующее поле.</p>
                        <p><i>Числовые значения должны быть в <strong>квадратных сантиметрах</strong> с точностью до <strong>второго</strong> десятичного знака.</i></p>
