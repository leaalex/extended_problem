...
* */
    ...
    let labels = {
        ru: {
            ...
            input_instruction: "Числа могут быть записаны в любой последовательности. Разделять числа следует любым удобным способом: через запятую, пробел или табуляцию.",
            start_instruction: ["После нажатия кнопки «Начать» Вам будет показана таблица с числами. Ваша задача заключается в том, чтобы за 20 секунд запомнить как можно больше чисел. Когда таблица исчезнет, вам необходимо записать числа, которые вы запомнили, в открывшемся окне. Числа могут быть записаны в любой последовательности. Разделять числа следует любым удобным способом: через запятую, пробел или табуляцию."]
