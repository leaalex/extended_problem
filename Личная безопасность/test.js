if (MatchingTableObjects == undefined) {
    var MatchingTableObjects = {}
}
...
function MatchingTableObjects(element, data) {
    ...
    script.src = "https://cdnjs.cloudflare.com/ajax/libs/draggable/1.0.0-beta.8/sortable.js";
    ...
    script.onload = function () {
        const sortable = new Sortable.default(
            document.querySelectorAll(".conf-answers-place"), {
                draggable: document.querySelectorAll('.conf-item'),
                delay: 0,
            }
        );
